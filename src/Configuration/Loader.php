...
namespace robertsaupe\ConsoleApp\Configuration;

use InvalidArgumentException;
use robertsaupe\ConsoleApp\NotInstantiable;
use robertsaupe\ConsoleApp\Console\IO;
use robertsaupe\ConsoleApp\Exception\NoConfigurationFound;
...
final class Loader {
    ...
    private const FILE_NAME = 'console.json';
